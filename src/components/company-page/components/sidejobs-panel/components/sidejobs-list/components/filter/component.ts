...
import { SIDEJOB_STATUS_FILTER_TEXTS, SIDEJOB_STATUS_FILTER_VALUES } from './constants';
...
export class SidejobsListFilter extends BaseComponent {
  ...
  private renderStatusFilterOptions = () => {
    return SIDEJOB_STATUS_FILTER_VALUES.map(
  ...
  private handleStatusChange = () => {
    ...
    const status = this._statusInputRef.value.value as SidejobStatusFilterValue;
    this.dispatchEvent(
      new SidejobsFilterStateChangedEvent({
        ...this._filterState,
        status,
