...
export const GAME_ALERT_NAMES: Record<GameAlert, () => string> = {
  ...
  [ContractAlert.removeDisplayedContractAssignments]: () => msg('Remove displayed contract assignments'),
  ...
  [PrimaryActivityAlert.cancelDisplayedPrimaryActivities]: () => msg('Cancel displayed primary activities'),
};
